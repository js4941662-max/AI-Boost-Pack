import { GoogleGenAI, GenerateContentRequest, GenerateContentResponse, Content } from "@google/genai";
import { EXAMPLE_REPORT, EXAMPLE_IMAGE_DATA_URL } from '../exampleData';
